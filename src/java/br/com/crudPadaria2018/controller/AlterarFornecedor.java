...
import br.com.crudPadaria2018.dao.FornecedorDAO;
 ...
 * @author Servidor
 */
@WebServlet(name = "AlterarFornecedor", urlPatterns = {"/AlterarFornecedor"})
public class AlterarFornecedor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       oFornecedor.setNomeFornecedor(nomeFornecedor);
       ...
       try{
           ...
           if(dao.cadastrar(oFornecedor)){
               ...
               mensagem = "Problemas ao cadastrar Fornecedor. Verifique os dados informados e "
                       + "tente novamente";
           }
           request.setAttribute("mensagem", mensagem);
           request.getRequestDispatcher("ListarFornecedor").forward(request, response);
       }catch(Exception ex){
           System.out.println("Problemas no Servlet ao cadastrar Fornecedor! Erro: " + ex.getMessage());
       }
    }
