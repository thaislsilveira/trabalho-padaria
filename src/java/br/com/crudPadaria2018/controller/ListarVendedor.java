 ...
 * @author Servidor
 */
@WebServlet(name = "ListarVendedor", urlPatterns = {"/ListarVendedor"})
public class ListarVendedor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
          ...
          try
        {
            ...
            request.setAttribute("vendedores", dao.Listar());
            request.getRequestDispatcher("vendedor.jsp").forward(request, response);
        }
        catch(Exception ex){
            System.out.println("Problemas no Servlet ao Listar Vendedor! Erro: " + ex.getMessage());
        }
    }
