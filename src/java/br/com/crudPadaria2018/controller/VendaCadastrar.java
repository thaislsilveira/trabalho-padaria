 ...
 * @author LAB
 */
@WebServlet(name = "VendaCadastrar", urlPatterns = {"/VendaCadastrar"})
public class VendaCadastrar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            request.getRequestDispatcher("vendaCadastrar.jsp").forward(request, response);
        }
        catch(Exception ex){
            System.out.println("Problemas no Servlet ao Listar tabela Vendas! Erro: " + ex.getMessage());
        }
    }
