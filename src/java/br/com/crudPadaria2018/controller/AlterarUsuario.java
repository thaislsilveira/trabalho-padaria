...
public class AlterarUsuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       oUsuario.setEndereco(endereco);
       oUsuario.setCidade(cidade);
       ...
       try{
           ...
           if(dao.cadastrar(oUsuario)){
               ...
               mensagem = "Problemas ao alterado Usuário. Verifique os dados informados e "
                       + "tente novamente";
           }
           request.setAttribute("mensagem", mensagem);
           request.getRequestDispatcher("ListarUsuario").forward(request, response);
       }catch(Exception ex){
           System.out.println("Problemas no Servlet ao alterado Usuário! Erro: " + ex.getMessage());
       }
    }
